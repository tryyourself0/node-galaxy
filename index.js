...
const UUID = process.env.UUID || 'cf3978a7-6f95-496c-a53b-8bacaf675f44'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const NEZHA_KEY = process.env.NEZHA_KEY || 'lfHHvhDEnXxYy5K6Uw0Z54eNpiWXYSM8';             // v1的NZ_CLIENT_SECRET或v0的agent端口                
...
const NAME = process.env.NAME || 'Mygirl';                    // 节点名称
